    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative px-4">
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <motion.div
          ...
          className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-10 md:p-14 lg:p-16 shadow-2xl relative overflow-hidden group cursor-pointer"
        >
          ...
          <motion.h1 
            ...
            style={{ fontSize: 'clamp(1.4rem, 4.8vw, 4.5rem)' }}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 min-h-[48px] bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-semibold border border-blue-400/30 backdrop-blur-sm relative overflow-hidden group flex items-center justify-center"
            >
            ...
            <motion.a
              href="https://drive.google.com/file/d/171HWEhnfYb2zM1Y666XD-cx5IJoOlZ2g/view?usp=sharing"
              target="_blank"
