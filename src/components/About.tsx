        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-white mb-2 text-center">Tharun Ratnala</h3>
              <p className="text-blue-200 text-center mb-6">Final Year Engineering Student</p>
